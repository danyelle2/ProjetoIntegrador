...
namespace ProjetoIntegrador.Controller.Aluno
{
    public class RepositorioAluno
    {
        ...
        {
            string query = @"INSERT INTO aluno (nome, idade, telefone, data_entrada, plano, responsavel, status) 
                         VALUES (@nome, @idade, @telefone, @data, @plano, @responsavel, @status)";
            ...
            new MySql.Data.MySqlClient.MySqlParameter("@data", aluno.DataEntrada),
